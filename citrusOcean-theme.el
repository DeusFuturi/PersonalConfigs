...
;;; Commentary:
;; You should install the Montserrat font on your computer before using this theme.
;; URL: https://fonts.google.com/specimen/Montserrat
;; To use rainbow-delimiters, you should install rainbow-delimiters from MELPA.
;; URL: https://melpa.org/#/rainbow-delimiters
;; Or you can use M-x package-install to install.

;;; Code:
(deftheme citrusOcean
  "A dark theme based on orange and blue")
...
(let ((font-default "Montserrat")
  ...
  (custom-set-faces
   ...
   (custom-theme-set-faces
    'citrusOcean
    `(default ((t (:family ,font-default :width normal :weight normal :slant normal :foreground ,primary :distant-foreground ,light :background ,background :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :inherit nil))))
...
;;; citrusOcean-theme.el ends here
